...
#
# 2025/09/30 ImageMaskDatasetGenerator.py
...
class ImageMaskDatasetGenerator:
  ...
  def generate(self):
    ...
    for i in range(num_files):
      ...
      if os.path.exists(image_file) and os.path.exists(mask_file):
        ...
        input("----Unmatched image and mask filename")
  ...
  def generate_image_files(self, image_file, index):
  ...
  def generate_mask_files(self, mask_file, index ):
...
if __name__ == "__main__":
  try:
    #Modified original folder names to be ordinary ascii strings 
    images_dir  = "./STROKE-DATASET/YARISMA-VERI-SETI_2_OTURUM/PNG/"
    masks_dir   = "./STROKE-DATASET/YARISMA-VERI-SETI_2_OTURUM/MASKS"
